...
pub const TUI_VISIBLE_COLLABORATION_MODES: [ModeKind; 3] =
    [ModeKind::Default, ModeKind::MerakPlan, ModeKind::Plan];

impl ModeKind {
    pub const fn display_name(self) -> &'static str {
        match self {
            Self::MerakPlan => "Merak Plan",
            Self::Plan => "Plan",
    ...
    pub const fn is_tui_visible(self) -> bool {
        matches!(self, Self::MerakPlan | Self::Plan | Self::Default)
    }

    pub const fn is_plan_like(self) -> bool {
        matches!(self, Self::MerakPlan | Self::Plan)
    }
...
mod tests {
    ...
    fn tui_visible_collaboration_modes_match_mode_kind_visibility() {
        let expected = [ModeKind::Default, ModeKind::MerakPlan, ModeKind::Plan];
